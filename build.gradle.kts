...
tasks {
  generateLexer {
    sourceFile.set(file("src/main/lexer/XdtLexer.flex"))
    targetDir.set("src/main/gen/com/github/aignatev/intellijxdtsyntax/xdt")
    targetClass.set("XdtLexer")
    purgeOldFiles.set(true)
  }
}

tasks.named("compileKotlin") { dependsOn(tasks.named("generateLexer")) }
